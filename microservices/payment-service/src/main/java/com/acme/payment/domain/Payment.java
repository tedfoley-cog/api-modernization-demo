 ...
 *
 * <p>This is a fresh entity owned by the payment service. It deliberately does not
 * reference loan or account entities — the only link to other domains is the opaque
 * {@code loanId} identifier. Cross-domain effects are emitted as events, not joins.
 */
@Entity
@Table(name = "payments")
